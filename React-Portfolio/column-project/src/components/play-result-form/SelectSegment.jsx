...
const SelectSegment = function SelectSegment({
  ...
  const conditionalTailwind = playr
    ? "text-black p-1 rounded-sm text-center h-8 w-full m-auto"
    : "text-black p-1 rounded-sm text-center h-8 w-3/5 m-auto";
